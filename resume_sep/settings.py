"""
Django settings for resume_sep project.
...
SECRET_KEY = 'django-insecure-#j3=9-y5o+(aj%z=%y860mgmxb_4en%dp@@q%&&w2fbc!wo1-1'
...
WSGI_APPLICATION = 'resume_sep.wsgi.application'
