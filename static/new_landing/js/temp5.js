...
function education() {
  ...
  function generateProjectDisplayDiv(projectCount, displayDivId) {
    ...
    '<h6 class="last-heading" id="displayProjectName' + projectCount + '" style="font-family: "GFS Didot", serif; font-style: normal; font-size: 16px;">Fees Management System</h6>' +
  ...
  function generateExperienceDisplayDiv(experienceCount) {
    ...
    '<h6 class="last-heading" id="displayDesignation' + experienceCount + '" style="font-family: \"GFS Didot\", serif; font-style: normal; font-size: 16px;">Job Title</h6>' +
    '<p class="content-text" style="margin-bottom: 0px; font-family: \"GFS Didot\", serif; font-style: normal; font-size: 16px;" id="displayCompany' + experienceCount + '">Company Name</p>'
    +
