...
function education() {
  ...
  function generateExperienceDisplayDiv(experienceCount) {
    ...
    '<p class="job-title" id="Display_Designation' + experienceCount + '" style="    font-size: 20px;font-weight: bold;font-family: "Helvetica", Times, serif;text-align: start; color: #45595b;">' +
    'Product Designer' +
    '</p>' +
    '<p  class="grey italic" style="font-size: 14px;">' +
