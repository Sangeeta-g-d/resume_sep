...
function education() {
  ...
  function generateDisplayDiv(educationCount) {
    ...
    displayDiv.innerHTML = 
      '<div>' +
      '<div class="sub_heading1" style="display: flex; justify-content: space-between; font-size: 17px; text-align: start; font-weight: bold; line-height: 10px; font-family: Times New Roman;">'+
    '<div>'+
        '<p id="displayDegree' + educationCount + '" style="font-size: 17px; line-height: 8px;"><b>Bachelor of Engineering</b></p>'+
    '</div>'+
    '<div>'+
        '<p class="date" style="font-size: 14px; line-height: 4px;">'+
            '<span id="displayDegreeFrom' + educationCount + '"><b>2015</b></span> | <span id="displayDegreeTo' + educationCount + '"><b>2017</b></span>'+
        '</p>'+
    '</div>'+
'</div>'
 +
 '<p id="displayCollege' + educationCount + '" class="sub_heading2" style="font-size: 14px; text-align: start; font-weight: bold; line-height: 8px; font-family: Times New Roman;">' +
 institution + ' <p style="font-size: 14px; text-align: start; font-weight: bold; line-height: 8px; font-family: Times New Roman;"><span id="displayCity' + educationCount + '">' + city + '</span>' +'</p> '+
'</p>'
+
      '</div>';
  ...
  '<p class="job-title" id="pjt' + projectCount + '" style="font-size: 17px;text-align: start;font-weight: bold;line-height: 10px;font-family: Times New Roman;">' +
    '<span id="displayProjectName' + projectCount + '"><b>Fees Management System</b></span>' +
  '</p>' +
  '<div style="font-size: 14px;text-align: start;font-weight: bold;line-height: 8px;font-family: Times New Roman;">' +
    '<p id="displayProjectTools' + projectCount + '">' + 'Tools used |' + 
      'Python, Django, MySQL, Excel' +
    '</p>' +
  '</div>' +
  '<p id="displayProjectDes' + projectCount + '" style="font-family: Times New Roman;text-align: start;font-size: 13px;">' +
...
'</div>';
  ...
  function generateExperienceDisplayDiv(experienceCount) {
    ...
    '<div class="sub_heading1" style="display: flex; justify-content: space-between; font-size: 17px; text-align: start; font-weight: bold; line-height: 10px; font-family: Times New Roman;">'+
    '<div>'+
        '<p id="Display_Designation' + experienceCount + '">Product Designer</p>'+
    '</div>'+
    '<div>'+
        '<p class="date">'+
            '<span id="Display_From' + experienceCount + '">2019</span> - <span id="Display_To' + experienceCount + '">Present</span>'+
        '</p>'+
    '</div>'+
'</div>'
+

    '<p style="text-align:start; font-weight: bold;line-height: 8px;font-family: Times New Roman;">' +
    '<span id="Display_Cname' + experienceCount + '"> Fintef</span>'+ '</p> '+
    
    '<p id="Display_Description' + experienceCount + '"  style=" font-family: Times New Roman; text-align: start;font-size: 13px;">' +
    'Designing end-to-end experience for financial products on mobile & web platforms. Working closely with managers, marketing specialists, and developers.' +
    '</p>' +
